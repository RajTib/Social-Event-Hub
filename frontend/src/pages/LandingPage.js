...
const LandingPage = ({ setIsLoggedIn }) => {
  ...
  const handleLoginSuccess = () => {
    setIsLoggedIn(true);
    navigate("/home"); // login still goes straight to home
  };

  const handleRegisterSuccess = () => {
    setIsLoggedIn(true);
    navigate("/quiz"); // registration now goes to quiz page first
  };
      ...
      <main className="flex-grow container mx-auto p-8 flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:space-x-12">
        <div className="text-center md:text-left md:w-1/2">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-6">
            ...
            Whether you're feeling energetic, social, or calm, find your perfect
            vibe and meet people who get it.
          </p>
        </div>
          ...
          {showForm === "login" ? (
            ...
            <div className="p-8 bg-white rounded-lg shadow-xl text-center">
              ...
              <p className="text-gray-600 mb-6">
                Join MoodMeet today and start your journey to better
                connections.
              </p>
              <button
